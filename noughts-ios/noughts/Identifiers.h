...
// Notification keys
FOUNDATION_EXPORT NSString* const kFacebookLoginNotification;
FOUNDATION_EXPORT NSString* const kFacebookProfileLoadedNotification;
FOUNDATION_EXPORT NSString* const kFacebookFriendsLoadedNotification;
