// Modified version of GWT's JSONParser class, imported here to make it output
// Closure-compatible javascript.
...
public class JSONParser {
  ...
  private static native JavaScriptObject initTypeMap() /*-{
    var result = {};
    result["boolean"] = @com.google.gwt.json.client.JSONParser::createBoolean(Z);
    result["number"] = @com.google.gwt.json.client.JSONParser::createNumber(D);
    result["string"] = @com.google.gwt.json.client.JSONParser::createString(Ljava/lang/String;);
    result["object"] = @com.google.gwt.json.client.JSONParser::createObject(Ljava/lang/Object;);
    result["function"] = @com.google.gwt.json.client.JSONParser::createObject(Ljava/lang/Object;);
    result["undefined"] = @com.google.gwt.json.client.JSONParser::createUndefined();
    return result;
  }-*/;
