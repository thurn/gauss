...
public interface Bus {
  ...
  public <V> Deferred<V> once(Key<?> key, Callback0<V> subscriber);

  public <V> Deferred<V> once(ImmutableList<Key<?>> keys, Callback0<V> subscriber);

  public <V,A> Deferred<V> once(Key<A> one, Callback1<V,A> subscriber);

  public <V,A> Deferred<V> once(Key<A> one, ImmutableList<Key<?>> rest, Callback1<V,A> subscriber);

  public <V,A,B> Deferred<V> once(Key<A> one, Key<B> two, Callback2<V,A,B> subscriber);

  public <V,A,B> Deferred<V> once(Key<A> one, Key<B> two, ImmutableList<Key<?>> rest,
      Callback2<V,A,B> subscriber);

  public <V,A,B,C> Deferred<V> once(Key<A> one, Key<B> two, Key<C> three,
  ...
  public <V> Deferred<V> once(ImmutableList<Key<?>> keys, Callback<V> subscriber);
