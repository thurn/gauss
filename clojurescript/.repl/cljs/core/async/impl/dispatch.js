...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16158 = (0);while(true){
var m_16159 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16159 == null))
{} else
{m_16159.call(null);
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7296__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7296__auto__)
