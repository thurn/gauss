...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__7875__auto__,writer__7876__auto__,opt__7877__auto__){return cljs.core._write.call(null,writer__7876__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_16065 = (0);while(true){
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__7875__auto__,writer__7876__auto__,opt__7877__auto__){return cljs.core._write.call(null,writer__7876__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_16072 = (self__.level + (1));while(true){
if((i_16072 <= (new_level + (1))))
{(update[i_16072] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16074 = (0);while(true){
if((i_16074 <= self__.level))
{var links_16075 = (update[i_16074]).forward;if(((links_16075[i_16074]) === x__$1))
{(links_16075[i_16074] = (x__$1.forward[i_16074]));
{
var G__16076 = (i_16074 + (1));
i_16074 = G__16076;
continue;
}
} else
{{
var G__16077 = (i_16074 + (1));
i_16074 = G__16077;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7308__auto__ = (cljs.core.truth_((function (){var and__7296__auto__ = me;if(cljs.core.truth_(and__7296__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7296__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7308__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7308__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7308__auto__,timeout__$1,me))
,msecs);
