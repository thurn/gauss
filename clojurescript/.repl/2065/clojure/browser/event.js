...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj14974 = {};return obj14974;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7195__auto__ = this$;if(and__7195__auto__)
...
{var x__7834__auto__ = (((this$ == null))?null:this$);return (function (){var or__7207__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7834__auto__)]);if(or__7207__auto__)
{return or__7207__auto__;
} else
{var or__7207__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7207__auto____$1)
...
return (function (p__14975){var vec__14976 = p__14975;var k = cljs.core.nth.call(null,vec__14976,0,null);var v = cljs.core.nth.call(null,vec__14976,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__14977){var vec__14978 = p__14977;var k = cljs.core.nth.call(null,vec__14978,0,null);var v = cljs.core.nth.call(null,vec__14978,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
