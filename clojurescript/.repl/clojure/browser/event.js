...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj17649 = {};return obj17649;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7519__auto__ = this$;if(and__7519__auto__)
...
{var x__8158__auto__ = (((this$ == null))?null:this$);return (function (){var or__7531__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8158__auto__)]);if(or__7531__auto__)
{return or__7531__auto__;
} else
{var or__7531__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7531__auto____$1)
...
return (function (p__17650){var vec__17651 = p__17650;var k = cljs.core.nth.call(null,vec__17651,(0),null);var v = cljs.core.nth.call(null,vec__17651,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__17652){var vec__17653 = p__17652;var k = cljs.core.nth.call(null,vec__17653,(0),null);var v = cljs.core.nth.call(null,vec__17653,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
