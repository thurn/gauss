...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj18786 = {};return obj18786;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7274__auto__ = this$;if(and__7274__auto__)
...
{var x__7913__auto__ = (((this$ == null))?null:this$);return (function (){var or__7286__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7913__auto__)]);if(or__7286__auto__)
{return or__7286__auto__;
} else
{var or__7286__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7286__auto____$1)
...
return (function (p__18787){var vec__18788 = p__18787;var k = cljs.core.nth.call(null,vec__18788,(0),null);var v = cljs.core.nth.call(null,vec__18788,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__18789){var vec__18790 = p__18789;var k = cljs.core.nth.call(null,vec__18790,(0),null);var v = cljs.core.nth.call(null,vec__18790,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
