...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj14953 = {};return obj14953;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7194__auto__ = this$;if(and__7194__auto__)
...
{var x__7833__auto__ = (((this$ == null))?null:this$);return (function (){var or__7206__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7833__auto__)]);if(or__7206__auto__)
{return or__7206__auto__;
} else
{var or__7206__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7206__auto____$1)
...
return (function (p__14954){var vec__14955 = p__14954;var k = cljs.core.nth.call(null,vec__14955,0,null);var v = cljs.core.nth.call(null,vec__14955,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__14956){var vec__14957 = p__14956;var k = cljs.core.nth.call(null,vec__14957,0,null);var v = cljs.core.nth.call(null,vec__14957,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
