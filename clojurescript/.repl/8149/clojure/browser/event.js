...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj15391 = {};return obj15391;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7267__auto__ = this$;if(and__7267__auto__)
...
{var x__7906__auto__ = (((this$ == null))?null:this$);return (function (){var or__7279__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7906__auto__)]);if(or__7279__auto__)
{return or__7279__auto__;
} else
{var or__7279__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7279__auto____$1)
...
return (function (p__15392){var vec__15393 = p__15392;var k = cljs.core.nth.call(null,vec__15393,(0),null);var v = cljs.core.nth.call(null,vec__15393,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__15394){var vec__15395 = p__15394;var k = cljs.core.nth.call(null,vec__15395,(0),null);var v = cljs.core.nth.call(null,vec__15395,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
