...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj8874 = {};return obj8874;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7369__auto__ = this$;if(and__7369__auto__)
...
{var x__8008__auto__ = (((this$ == null))?null:this$);return (function (){var or__7381__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8008__auto__)]);if(or__7381__auto__)
{return or__7381__auto__;
} else
{var or__7381__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7381__auto____$1)
...
return (function (p__8875){var vec__8876 = p__8875;var k = cljs.core.nth.call(null,vec__8876,(0),null);var v = cljs.core.nth.call(null,vec__8876,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__8877){var vec__8878 = p__8877;var k = cljs.core.nth.call(null,vec__8878,(0),null);var v = cljs.core.nth.call(null,vec__8878,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
