...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write(writer__4128__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13531 = (0);while(true){
if((i_13531 < arr.length))
{(arr[i_13531] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write(writer__4128__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13538 = (self__.level + (1));while(true){
if((i_13538 <= (new_level + (1))))
{(update[i_13538] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13540 = (0);while(true){
if((i_13540 <= self__.level))
{var links_13541 = (update[i_13540]).forward;if(((links_13541[i_13540]) === x__$1))
{(links_13541[i_13540] = (x__$1.forward[i_13540]));
{
var G__13542 = (i_13540 + (1));
i_13540 = G__13542;
continue;
}
} else
{{
var G__13543 = (i_13540 + (1));
i_13540 = G__13543;
continue;
}
}
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3560__auto__,timeout__$1,me){
