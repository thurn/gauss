...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13524 = (0);while(true){
if((i_13524 < arr.length))
{(arr[i_13524] = null);
{
...
{var i_13531 = (self__.level + (1));while(true){
if((i_13531 <= (new_level + (1))))
{(update[i_13531] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13533 = (0);while(true){
if((i_13533 <= self__.level))
{var links_13534 = (update[i_13533]).forward;if(((links_13534[i_13533]) === x__$1))
{(links_13534[i_13533] = (x__$1.forward[i_13533]));
{
