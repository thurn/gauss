...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13617 = (0);while(true){
var m_13618 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13618 == null))
{} else
{m_13618.call(null);
if((count_13617 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13619 = (count_13617 + (1));
count_13617 = G__13619;
continue;
}
} else
{}
